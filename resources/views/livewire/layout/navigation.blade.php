...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                @auth
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            {{-- Estes são os links que deveriam estar na sua "sidebar" --}}
                            ...
                            @if(auth()->user()->is_admin)
                                ...
                                <x-dropdown-link :href="route('admin.raffles.index')" wire:navigate>
                                    {{ __('Painel Admin') }}
                                </x-dropdown-link>
                            @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        {{-- ... (menu responsivo, pode ser ajustado da mesma forma) ... --}}
    </div>
</nav>
