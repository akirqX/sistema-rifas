        ...
        <div class="container mx-auto px-4">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-bg-secondary p-8 rounded-2xl border border-border shadow-2xl mb-8">
                    ...
                    {{-- LÓGICA CORRIGIDA PARA EXIBIR APENAS UM BLOCO DE STATUS --}}
                    ...
                    @if($order->status == 'pending')
                        <div class="text-center">
                            ...
                            @else
                                <div class="text-center p-6 bg-yellow-500/20 rounded-lg border border-yellow-500/30">
                                    <h4 class="text-lg font-bold text-yellow-300">Processando Pagamento</h4>
                                    <p class="text-yellow-400/80 mt-1">Aguardando a geração dos dados de pagamento...</p>
                                </div>
                            @endif
                        </div>
                    ...
                    @else {{-- O status é 'cancelled' ou qualquer outro --}}
                        <div class="text-center p-6 bg-red-500/20 rounded-lg border border-red-500/30">
                            ...
                            <p class="text-red-400/80 mt-1">O tempo para pagamento deste pedido expirou ou ele foi cancelado.</p>
                        </div>
                    @endif
                </div>
